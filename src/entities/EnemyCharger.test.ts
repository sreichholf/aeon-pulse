...
describe('EnemyCharger', () => {
  it('builds the Tactical Database viewer pose at construction time', () => {
    ...
    const internals = charger as unknown as {
      _topWingGroup: THREE.Group;
      _bottomWingGroup: THREE.Group;
    ...
    expect(internals._topWingGroup.rotation.z).toBeCloseTo(-0.05);
    expect(internals._bottomWingGroup.rotation.z).toBeCloseTo(0.05);
