...
export class EnemyTurret extends Enemy {
  ...
  static initSharedResources(): void {
    if (EnemyTurret._cachedGeometries) return;
  ...
  constructor(
    ...
    const mats = EnemyTurret._cachedMaterials!;
  ...
  private _build3DModel(): THREE.Group {
    ...
    const geos = EnemyTurret._cachedGeometries!;
    const mats = EnemyTurret._cachedMaterials!;
